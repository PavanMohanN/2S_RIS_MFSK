...
=====================================================
IEEE Transactions on Vehicular Technology target submission.
Two-stage T-RIS/R-RIS architecture for 28 GHz bistatic M-FSK sensing.

All physical constants, system parameters, and output settings are
defined here.  Every other module imports this file.

Reference paper parameters:
  Carrier: 28 GHz | N = 256 elements | M = 12 tones | Δf = 25 MHz
  Tsym = 1.40 μs | Nsw = 1024 | CPI = Nsw × Tsw

Equations referenced follow the paper numbering.
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
# 12. Publication figure style (IEEE TVT, double-column format)
# ═══════════════════════════════════════════════════════════════════════════════
...
# Colour palette (matched to IEEE TVT conventions, colour-blind safe)
COLORS = {
    'on':        '#1a6faf',   # Deep blue    — on-state / two-stage
    'off':       '#c1272d',   # Deep red     — off-state / image
    'sideband':  '#2e8b57',   # Dark green   — sideband / desired
    'carrier':   '#d97706',   # Amber        — carrier feedthrough
    'two_stage': '#1a6faf',   # Blue         — proposed two-stage
    'single':    '#c1272d',   # Red          — single-stage STM-RIS
    'fmcw':      '#2e8b57',   # Green        — FMCW radar
    'aesa':      '#d97706',   # Amber        — AESA radar
    'crb':       '#6b4ea0',   # Purple       — CRB curve
    'target1':   '#1a6faf',   # Blue         — target 1
    'target2':   '#c1272d',   # Red          — target 2
    'target3':   '#2e8b57',   # Green        — target 3
    'gray':      '#555555',   # Gray         — reference lines
}
...
def print_config_summary():
    ...
    print("  Target journal: IEEE Transactions on Vehicular Technology")
    print("═" * 60)
