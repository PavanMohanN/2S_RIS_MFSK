...
======================================================================
Assembles all simulation outputs into a complete publication-ready package.
Generates LaTeX figure / table insertion commands, a Markdown simulation
report containing all key numerical results, and a packaging shell script.

Outputs
-------
  paper_figures.tex    — LaTeX \\begin{figure} blocks for every figure
  paper_tables.tex     — LaTeX \\input commands for every table
  simulation_report.md — Comprehensive Markdown summary with all numbers
  package_paper.sh     — Shell script to copy everything into a LaTeX project
  data/all_results.npy — Unified data file with all phase results

Usage
-----
    python figures_tables.py          # standalone
